...
class Client
{
    ...
    {
        $this->client->on("connect", function ($client) { call_user_func_array([$this, 'connect'], [$client]); });
        $this->client->on("receive", function ($client, $data) { call_user_func_array([$this, 'receive'], [$client, $data]); });
        $this->client->on("error", function ($client) { call_user_func_array([$this, 'error'], [$client]); });
        $this->client->on("close", function ($client) { call_user_func_array([$this, 'close'], [$client]); });
